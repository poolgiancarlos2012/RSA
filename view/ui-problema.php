<div id="idframeproblema" style="">
	<input type="hidden" id="hdidproblema" name="">
	<input type="hidden" id="verifydup" name="">
	<div class="titulo" style="width: 262px;margin: 0 auto;padding: 30px 0;">
		<span style="font-family: 'Conv_futura_md_bt_bold';font-size: 20px;">Mantenimiento Problema</span>
	</div>
			...
			<table cellspacing=0 cellpadding=0 border=0 style="margin: 0 auto;">
				<tr>
	            	...
	            	<td align="left" valign="middle" style="width: 130px;height: 35px;">
		            	<span style="font-family: 'Conv_FuturaNormal';font-size: 14px;">Problema</span>
		            </td>
		            <td style="width: 10px;">&nbsp;</td>
	            	<td align="left" valign="middle" style="width: 200px;height: 35px;position: relative;">
		            	<!-- <div class="select-style" style="width:200px;font-weight:bold;">
		                    <select id='idmansearchproblema' name='idmansearchproblema'></select>
		                </div> -->
	...
	<table id="table_list_problema" align="center"></table>
	<div id="pager_table_list_problema"></div>
