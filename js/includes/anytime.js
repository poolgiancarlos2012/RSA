...
(function($)
{
	...
	//  This prevents the pickers from being too tall and wide.
  	...
  	{
  		return ( __msie6 ?
  					Number(this.css('height').replace(/[^0-9]/g,'')+3) :
  					this.outerHeight(inclusive)+3 );
  	};
	...
	__pickers[id] =
	{
		...
		initialize: function( id )
		{
			...
			options = jQuery.extend(true,{},options||{});
		  	...
		  	this.inp = $('#'+id);
		  	this.div = $( '<div class="AnyTime-win AnyTime-pkr ui-widget ui-widget-content ui-corner-all" style="width:0;height:280px" id="' + this.id + '" aria-live="off"/>' );
		    this.inp.after(this.div);
		  	...
		  	{
				/******kennedy******/
				this.xTable=$('<table style="position:relative;"></table>');
				this.xTr=$('<tr></tr>')
				this.xTd1=$('<td></td>');
				this.xTd2=$('<td></td>');
				  this.xTable.append( this.xTr );
				  this.xTr.append( this.xTd1 );
				  this.xTr.append( this.xTd2 );
				  this.xTd1.append( this.dD );

				/*************/
			  this.dD = $( '<div class="AnyTime-date" style="width:0;height:0"/>' );
			  /******kennedy*******/
			this.xTd1.append( this.dD );
			  this.dB.append( this.xTable );
			  /****************/
