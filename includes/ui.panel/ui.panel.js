    ...
    $.widget('ui.panel', {
        ...
        _create: function() {
            if (this.element.is('div')) {
				...
				//kennedy
				this.titleTextBox.html(o.title);
				//
                    ...
                    if (o.trueVerticalText){
                        ...
                        if (ie==''){
                            ...
                            titleTextBox
                                ...
                                .append('<div style="'+boxStyle+'z-index:3;"></div><object style="'+boxStyle+'z-index:2;" type="image/svg+xml" data="data:image/svg+xml;charset=utf-8,<svg xmlns=\'http://www.w3.org/2000/svg\'><text x=\'-'+(parseInt(o.vHeight)-60)+'px\' y=\'16px\' style=\'font-weight:'+titleTextBox.css('font-weight')+';font-family:'+titleTextBox.css('font-family').replace(/"/g, '')+';font-size:'+titleTextBox.css('font-size')+';fill:'+titleTextBox.css('color')+';\' transform=\'rotate(-90)\' text-rendering=\'optimizeSpeed\'>'+/*titleText*/o.title+'</text></svg>"></object>')
