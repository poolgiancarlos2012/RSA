        ...
        messageBox: function(type, message, properties, input) {
            ...
            $(this).chain(function () {
                ...
                if(type == 'alert' || type == 'info' || type == 'error')
                {
                    ...
                    $('#BoxAlertBtnOk').val(properties.textBoxBtnOk).css({
                        'width':70
                    });
                ...
                else if(type == 'confirm')
                {
                    ...
                    $('#'+this.options.name+'-Buttons').append('<input id="BoxConfirmBtnOk" class="btn" type="submit" /> <input class="btn" id="BoxConfirmBtnCancel" type="submit" />');
                ...
                else if(type == 'prompt')
                {
                    ...
                    $('#'+this.options.name+'-Buttons').append('<input class="btn" id="BoxPromptBtnOk" type="button" /> <input class="btn" id="BoxPromptBtnCancel" type="button" />');
