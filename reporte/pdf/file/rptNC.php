...
$sqldetdoc="  SELECT TRUNCATE(cant, 2) AS cant,codpro,um,prod,precio AS precio,precio_i AS precio_i,dscto AS dscto,subtot AS subtot FROM sfw.detalle_documento WHERE iddocumento=$iddocumento ORDER BY numdoc,item,prod;";
