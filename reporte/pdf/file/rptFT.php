...
$sqldoc="   SELECT 
            iddocumento,
            codage,ctd,numser,numdoc,documento,razon_social,codigo_cliente,ruc,direccion,remision,nro_oc,
            fecha_emi,fecha_venc,nropedido,cond_pago,repre_ventas,tot_ope_inaf,tot_ope_exo,tot_ope_grat,
            CAST(sum_igv AS DECIMAL(10,2)) AS sum_igv,impo_tot,firm_dig,docum_modif,denominacion,emitido,motivo,moneda,idcliente 
            FROM 
            sfw.documento WHERE 
